...
public class CodeGeneral {
    ...
    public interface Constant {
        String DB_JDBC_URL = "jdbc:mysql://192.168.172.130:3306" +
            "/omni_scheduler?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true";
        String DB_USER_NAME = "root";
        String DB_USER_PASSWORD = "SpacexHadoop123$%^";
        String DB_DRIVER_NAME = "com.mysql.jdbc.Driver";

        // database name
        String DB_SCHEMA_NAME = "omni_scheduler";

        /**
         * package 信息
         */
        String PACKAGE_PATH = "com.shuyun.omni.operation";
        String SUB_PACKAGE_PATH = "common";
